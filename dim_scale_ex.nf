...
def variables = [
    ...
    size: ["nothing"],
    seed: (1..10),
    data: ["colon","leukemia","ALLAML","Prostate_GE","BASEHOCK","madelon","RELATHE","PCMAC"],
...
process runSimulation {
    memory { estimateMemoryMinESS(arg.dim.toInteger(), ESS_threshold) * Math.pow(2, task.attempt-1) }
    time { 80.hour } 
    cpus 1
